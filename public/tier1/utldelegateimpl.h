...
// 02-Jul-19 xxx  * Use to Valve's dbg.h and COMPILE_TIME_ASSERT
...
#include "tier0/dbg.h" // COMPILE_TIME_ASSERT static assertion wrapper
...
inline OutputClass horrible_cast(const InputClass input)
{
	...
	COMPILE_TIME_ASSERT( "ERROR_CantUseHorrible_cast" && sizeof(InputClass)==sizeof(u) 
...
struct SimplifyMemFunc 
{
	...
	{ 
		...
		COMPILE_TIME_ASSERT("ERROR_Unsupported_member_function_pointer_on_this_compiler" && N-100>=0);
		return 0; 
	}
};
...
struct SimplifyMemFunc< SINGLE_MEMFUNCPTR_SIZE + sizeof(int) >  
{
	...
	{ 
		...
		COMPILE_TIME_ASSERT("ERROR_CantUsehorrible_cast" && sizeof(function_to_bind)==sizeof(u.s));
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 2*sizeof(int) >
{
		...
		GenericMemFuncType &bound_func) 
	{
		...
		COMPILE_TIME_ASSERT("ERROR_CantUsehorrible_cast"
...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
			...
			GenericMemFuncType &bound_func) 
	{
		...
		// Check that the horrible_cast will work
		COMPILE_TIME_ASSERT("ERROR_CantUseHorrible_cast" && sizeof(XFuncType)==sizeof(u.s));
...
// support static_cast between void * and function pointers.
				...
				StaticFuncPtr function_to_bind) 
	{
		...
		COMPILE_TIME_ASSERT("ERROR_CantUseEvilMethod" && sizeof(GenericClass *)==sizeof(function_to_bind));
...
//		m_pthis = reinterpret_cast<GenericClass *>(reinterpret_cast<long>(function_to_bind));
	...
	inline UnvoidStaticFuncPtr GetStaticFunction() const 
	{
		...
		// and data pointers have different sizes.
		// If you get this error, you need to #undef FASTDELEGATE_USESTATICFUNCTIONHACK.
		COMPILE_TIME_ASSERT("ERROR_CantUseEvilMethod" && sizeof(UnvoidStaticFuncPtr)==sizeof(this));
