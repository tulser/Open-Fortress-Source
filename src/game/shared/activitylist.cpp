...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_LAST_PRIMARYATTACK );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_VM_LAST_PRIMARYATTACK_CRIT );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_VM_CHARGEUP );
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_PULLBACK );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_AIRWALK_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_WALK_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_AIRWALK_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_JUMP_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_JUMP_START_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_JUMP_FLOAT_PISTOL);
	REGISTER_SHARED_ACTIVITY( ACT_MERC_JUMP_LAND_PISTOL);

	REGISTER_SHARED_ACTIVITY( ACT_MERC_STAND_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCH_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RUN_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_CROUCHWALK_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_SWIM_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_STAND_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_CROUCH_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_ATTACK_SWIM_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_STAND_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_CROUCH_PISTOL_MERCENARY );
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_SWIM_PISTOL_MERCENARY );	
	REGISTER_SHARED_ACTIVITY( ACT_MERC_RELOAD_AIRWALK_PISTOL_MERCENARY );	
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_PISTOL_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_PISTOL_MERCENARY);		
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_PISTOL_MERCENARY);		
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_PISTOL_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_PISTOL_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_PISTOL_MERCENARY);

	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_STAND_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_CROUCH_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_SWIM_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_AIRWALK_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_REVOLVER_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_REVOLVER_MERCENARY);

	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_STAND_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_CROUCH_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_SWIM_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_AIRWALK_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_PISTOL_AKIMBO);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_PISTOL_AKIMBO);
	
	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_STAND_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_CROUCH_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_SWIM_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_AIRWALK_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_SMG_MERCENARY);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_SMG_MERCENARY);

	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_FLAMETHROWER);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_FLAMETHROWER);

	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_STAND_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_CROUCH_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_SWIM_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_AIRWALK_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_SUPERSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_SUPERSHOTGUN);

	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_START_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_FLOAT_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_LAND_RAILGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_RAILGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_RAILGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_RAILGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_RAILGUN_DEPLOYED_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RAILGUN_DEPLOYED_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RAILGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RAILGUN_SWIM_DEPLOYED);
	...
	REGISTER_SHARED_ACTIVITY(ACT_MERC_STAND_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCH_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RUN_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_CROUCHWALK_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_SWIM_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_STAND_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_CROUCH_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_ATTACK_SWIM_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_STAND_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_CROUCH_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_SWIM_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_RELOAD_AIRWALK_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_WALK_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_AIRWALK_DYNAMITE);
	REGISTER_SHARED_ACTIVITY(ACT_MERC_JUMP_DYNAMITE);
