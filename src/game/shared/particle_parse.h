...
enum ParticleAttachment_t
{
	...
	PATTACH_GORE_LOWERARM_L,
	PATTACH_GORE_UPPERARM_R,
	PATTACH_GORE_LOWERARM_R,
	PATTACH_GORE_UPPERLEG_L,
	PATTACH_GORE_LOWERLEG_L,
	PATTACH_GORE_UPPERLEG_R,
	PATTACH_GORE_LOWERLEG_R,
