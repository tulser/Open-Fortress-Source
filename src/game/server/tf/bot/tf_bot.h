...
public:
	...
	bool			ShouldFireCompressionBlastAtFriend( void );
	...
	void			LeaveSquad( void );

	void			TouchJumpPad( void );
	...
	// these are used so that the respective actions can cancel themselves upon being true
