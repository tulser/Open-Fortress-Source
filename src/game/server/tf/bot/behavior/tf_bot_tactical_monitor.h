...
private:
	...
	CountdownTimer m_checkGetWeaponTimer;
	CountdownTimer m_checkGetPowerupTimer;

	CountdownTimer m_checkUseMapTeleportTimer;
	CountdownTimer m_checkUseJumpPadTimer;
};
