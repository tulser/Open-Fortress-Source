...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_PULLBACK );
	...
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_PISTOL );	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_WALK_PISTOL	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_AIRWALK_PISTOL	);	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_PISTOL	);		
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_START_PISTOL	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_FLOAT_PISTOL	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_LAND_PISTOL	);
	
	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_PISTOL_MERCENARY );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_PISTOL_MERCENARY );	
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_PISTOL_MERCENARY );	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_WALK_PISTOL_MERCENARY	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_AIRWALK_PISTOL_MERCENARY	);	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_PISTOL_MERCENARY	);		
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_START_PISTOL_MERCENARY	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_FLOAT_PISTOL_MERCENARY	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_LAND_PISTOL_MERCENARY	);

	ADD_ACTIVITY_TO_SR( ACT_MERC_STAND_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCH_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RUN_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_CROUCHWALK_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_SWIM_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_STAND_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_CROUCH_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_ATTACK_SWIM_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_STAND_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_CROUCH_PISTOL_AKIMBO );
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_SWIM_PISTOL_AKIMBO );	
	ADD_ACTIVITY_TO_SR( ACT_MERC_RELOAD_AIRWALK_PISTOL_AKIMBO );	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_WALK_PISTOL_AKIMBO	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_AIRWALK_PISTOL_AKIMBO	);	
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_PISTOL_AKIMBO	);		
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_START_PISTOL_AKIMBO	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_FLOAT_PISTOL_AKIMBO	);
	ADD_ACTIVITY_TO_SR(	ACT_MERC_JUMP_LAND_PISTOL_AKIMBO	);

	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_REVOLVER_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_REVOLVER_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_SMG_MERCENARY);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_SMG_MERCENARY);

	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_FLAMETHROWER);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_FLAMETHROWER);
	...
	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_SUPERSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_SUPERSHOTGUN);

	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_RAILGUN);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_RAILGUN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_RAILGUN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_RAILGUN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_RAILGUN_DEPLOYED_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RAILGUN_DEPLOYED_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RAILGUN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RAILGUN_SWIM_DEPLOYED);
	...
	ADD_ACTIVITY_TO_SR(ACT_MERC_STAND_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCH_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RUN_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_CROUCHWALK_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_SWIM_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_STAND_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_CROUCH_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_ATTACK_SWIM_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_STAND_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_CROUCH_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_SWIM_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_RELOAD_AIRWALK_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_WALK_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_AIRWALK_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_START_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_FLOAT_DYNAMITE);
	ADD_ACTIVITY_TO_SR(ACT_MERC_JUMP_LAND_DYNAMITE);

	ADD_ACTIVITY_TO_SR( ACT_MERC_LOADOUT );
#endif
}
