...
public:
	...
	virtual void InitClientRenderTargets ( IMaterialSystem* pMaterialSystem, IMaterialSystemHardwareConfig* pHardwareConfig, int iWaterTextureSize = 1024, int iCameraTextureSize = 512 );
...
protected:
	...
	ITexture* CreateCameraTexture( IMaterialSystem* pMaterialSystem, int iSize = 512 );
