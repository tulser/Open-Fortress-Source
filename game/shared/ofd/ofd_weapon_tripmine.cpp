...
#define TRIPMINE_MODEL "models/weapons/w_models/w_grenade_tripmine.mdl"


class CWeaponTripMine : public CTFWeaponBase
{
	DECLARE_CLASS( CWeaponTripMine, CTFWeaponBase );
public:
...
void CWeaponTripMine::PrimaryAttack( void )
{
	...
	if ( tr.fraction < 1.0 )
	{
		...
		if ( pEntity && !( pEntity->GetFlags() & FL_CONVEYOR ) )
		{
			...
			CBaseEntity::Create( "tf_projectile_tripmine", tr.endpos + tr.plane.normal * 2, angles, pPlayer );
